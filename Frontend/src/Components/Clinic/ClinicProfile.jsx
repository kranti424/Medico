...
const ClinicProfile = () => {
  ...
  useEffect(() => {
    ...
    if (storedData) {
      setClinicData(JSON.parse(storedData));
    }
  }, []);
        ...
        <motion.div 
          ...
          <div className="bg-white px-8 py-4 flex flex-wrap items-center gap-6 mt-16">
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span>Est. {clinicData.establishedYear}</span>
            </div>
            <div className="flex items-center gap-2 text-gray-600">
          ...
          <motion.div
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">{clinicData.establishedYear}</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">{clinicData.phone}</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href={clinicData.website} target="_blank" rel="noopener noreferrer" 
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-lg font-medium">{clinicData.phone}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Alternate Contact</p>
                    <p className="text-lg font-medium">{clinicData.alternatePhone}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Email Address</p>
                    <p className="text-lg font-medium">{clinicData.email}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 mb-1">Pincode</p>
                    <p className="text-lg font-medium">{clinicData.pincode}</p>
                  </div>
                </div>

                <div>
                  <p className="text-sm text-gray-600 mb-1">About</p>
                  <p className="text-gray-700">{clinicData.description}</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="h-64 rounded-lg overflow-hidden">
                <MapContainer 
                  center={[clinicData.latitude, clinicData.longitude]} 
                  zoom={15} 
                  ...
                  <TileLayer
                    ...
                    />
                  <Marker position={[clinicData.latitude, clinicData.longitude]}>
                    <Popup>
                      <div className="p-2">
                        <h3 className="font-semibold">{clinicData.clinicName}</h3>
              ...
              <a
                href={`https://www.openstreetmap.org/directions?from=&to=${clinicData.latitude},${clinicData.longitude}`}
                target="_blank"
